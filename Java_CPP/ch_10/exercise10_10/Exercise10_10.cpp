...
/**
 * *10.10 (The Queue class) Design a class named Queue for storing integers.
 * The class contains:
 * - An internal dynamic array field that stores int values in the queue.
 * - A size data field that stores the number of elements in the queue.
...
private:
    ...
    void ensure_capacity()
    {
        if (size >= capacity)
        {
            ...
            elements = std::move(new_elements); // Automatically frees old allocation
